...
public class StampaAuto extends javax.swing.JInternalFrame {
    ...
    private void btnCercaActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnCercaActionPerformed
        ...
        automobili = MyLibrary.LeggiFile();
        if(MyLibrary.VerificaPosizione(txtPosizione, automobili))
        {
            a = automobili.get(Integer.parseInt(txtPosizione.getText()));
            path = a.getMarca() + a.getModello() + "_" + automobili.indexOf(a) + ".txt";
            txtaDatiAutomobile.setText(a.toString());
            btnStampa.setEnabled(true);
            btnStampa.setText("Salva su " + path);
        }   
    ...
    private void btnStampaActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnStampaActionPerformed
        ...
        path = ""
                + a.getMarca() + a.getModello() 
                + "_" + automobili.indexOf(a) 
