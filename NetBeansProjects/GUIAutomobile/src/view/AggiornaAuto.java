...
public class AggiornaAuto extends javax.swing.JInternalFrame {
    ...
    private void btnAggiornaActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnAggiornaActionPerformed
        ...
        if(MyLibrary.VerificaDatiCorretti(a, txtCilindrata))
        {
            ArrayList<Automobile> automobili = MyLibrary.LeggiFile();
            int index = Integer.parseInt(txtPosizione.getText());
            a.setCilindrata(Integer.parseInt(txtCilindrata.getText()));
            automobili.set(index, a);
            MyLibrary.ScriviFile(automobili);
            JOptionPane.showMessageDialog(null,"Dati aggiornati con successo");
        }
        else 
            JOptionPane.showMessageDialog(null,"Errore!\nCompletare tutti i campi e\ncontrollare che la cilindrata sia un intero positivo");
